...
- The first exercise consists on implement a new output adapter. We add a new single file to the application and do not need to modify any of the other files.
